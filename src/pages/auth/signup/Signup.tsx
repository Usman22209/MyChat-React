      ...
      <div className="w-full max-w-md">
        <div className="bg-bg-primary rounded-xl p-8 shadow-lg transition-all duration-300">
          <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-text-secondary transition-colors duration-300">Join us today</p>
          </div>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-blue-500 hover:bg-button-hover  back text-white py-3 rounded-lg font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-lg"
            >
              {formik.isSubmitting ? (
