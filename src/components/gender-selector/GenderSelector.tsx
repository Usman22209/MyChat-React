...
const GenderSelector = ({ value, onChange }) => {
  ...
  const genderOptions = [
    { 
      ...
      activeColor: isDark ? 'bg-gradient-to-br from-blue-300 to-blue-500' : 'bg-gradient-to-br from-blue-500 to-blue-700',
    ...
    { 
      ...
      activeColor: isDark ? 'bg-gradient-to-br from-rose-300 to-rose-500' : 'bg-gradient-to-br from-rose-500 to-rose-700',
    ...
    { 
      ...
      activeColor: isDark ? 'bg-gradient-to-br from-violet-300 to-violet-500' : 'bg-gradient-to-br from-violet-500 to-violet-700',
    ...
    { 
      ...
      activeColor: isDark ? 'bg-gradient-to-br from-gray-300 to-gray-500' : 'bg-gradient-to-br from-gray-500 to-gray-700',
  ...
  return (
    <div className={`p-6 rounded-xl shadow-xl max-w-2xl mx-auto transition-all duration-300 ${isDark ? 'bg-gray-900 text-white' : 'bg-white text-gray-800'}`}>
      <h2 className={`text-center font-bold text-xl mb-6 ${isDark ? 'text-gray-100' : 'text-gray-800'}`}>
        Choose Your Gender
      </h2>
