...
import { Menu, X, MessageSquare, Shield, Globe, PhoneCall, Sun, Moon, LogOut } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-14 md:h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm md:text-base bg-red-500 hover:bg-red-600 text-white rounded-lg transition-all duration-200 flex items-center gap-2"
            >
            ...
            >
              <div className="flex flex-col space-y-2">
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-2 mt-2">
                  <button
                    onClick={handleLogout}
                    className="w-full px-4 py-2 text-xs sm:text-sm md:text-base bg-red-600 hover:bg-red-700 text-white rounded-lg transition-all duration-200"
                  >
                    Log out
                  </button>
                </div>
